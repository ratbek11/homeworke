# Здравствуйте!
# Не смог вовремя отправить домашку, так как у меня были проблемы
# с GitHub и PyCharm — не получилось привязать репозиторий.
# Сейчас все исправил и отправил не только эту работу, но и предыдущую.
